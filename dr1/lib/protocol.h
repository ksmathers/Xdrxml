...
#define DR1MSG_110 "110 LOAD GLYPH %s %s %d %d"
#define DR1MSG_115 "115 DEFINE MOBILE eid:%d glyph:%s type:%d"
#define DR1MSG_120 "120 MAP DATA"
#define DR1MSG_130 "130 MAP DELTA"
#define DR1MSG_135 "135 PROJECTILE %d %d %d %d %d %d"
#define DR1MSG_140 "140 ATTACK %d %d %s"
#define DR1MSG_150 "150 DEFEND %d %d %s %s"
#define DR1MSG_160 "160 MESSAGE %s"
#define DR1MSG_170 "170 PLAYER DATA"
#define DR1MSG_175 "175 LOCATION mapname:%s x:%d y:%d eid:%d"
